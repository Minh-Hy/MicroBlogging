...
export const TWEET_MESSAGES = {
  ...
  SOFT_DELETE_TWEET_SUCCESS: 'Soft delete tweet successfully',
  DELETE_TWEET_PERMISSION_DENIED: 'Permission denied: You can only delete your own tweets.',
  SOFT_DELETE_PERMISSION_DENIED: 'Permission denied: Only admin can soft delete',
  REASON_REQUIRED: 'Reason for deletion is required',
  TWEET_CREATED_SUCCESS: 'Tweet created successfully',
  GET_TWEET_SUCCESS: 'Get tweet success',
  FORBIDDEN_ACTION: 'Forbidden action',
  UPDATE_PERMISSION_DENIED: 'Permission denied: You can only update your own tweets.',
